...
export default function ParkingOwnerSignupScreen() {
          ...
          <View style={styles.pageContent}>
            <LoginFormContainer>
              ...
              <Text style={styles.subtitle}>
                Sign up as a parking owner for ParkOptima
              </Text>
              ...
              <View style={styles.loginRow}>
                ...
                <TouchableOpacity onPress={() => router.push('/parking_owner_login')} disabled={loading}>
