...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    setLoading(true);
    try {
      const response = await apiRequest<{ user_id: number; role: string }>('/api/parking-owner/login', {
        method: 'POST',
        body: JSON.stringify({ email: email.trim().toLowerCase(), password }),
      });

      if (remember) {
        await saveRememberedCredentials('parking-owner-login', { email: email.trim().toLowerCase(), password, remember: true });
      } else {
        await clearRememberedCredentials('parking-owner-login');
      }
          ...
          <LoginFormContainer>
            <View style={styles.formContent}>
              ...
              <Text style={styles.welcomeSubtitle}>
                Sign in to your parking owner account
              </Text>
              ...
              <View style={styles.inputWrapper}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="parkingowner@parkoptima.com"
              ...
              <View style={styles.signupRow}>
                ...
                <TouchableOpacity onPress={() => router.push('/parking_owner_signup')}>
